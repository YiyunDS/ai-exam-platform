        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center group cursor-pointer">
              ...
              <a href="/dashboard" className="btn-primary w-full inline-block">Get Started</a>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center group cursor-pointer">
              ...
              <a href="/analytics" className="btn-primary w-full inline-block">View Demo</a>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center group cursor-pointer">
              ...
              <a href="/groups" className="btn-primary w-full inline-block">Setup Groups</a>
            </div>
          </div>
        </div>
      </section>
